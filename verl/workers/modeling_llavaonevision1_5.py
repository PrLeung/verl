...
def apply_rotary_pos_emb(q, k, cos, sin, position_ids=None, unsqueeze_dim=1):
    ...
    """
    # print("q:", q.shape, "cos:", cos.shape, "sin:", sin.shape)
...
class LLaVAOneVision1_5_FlashAttention2(LLaVAOneVision1_5_Attention):
    ...
    def forward(
        ...
        cos, sin = position_embeddings
        # assert 1==3, f'query_states: {query_states.shape}, key_states: {key_states.shape}, cos: {cos.shape}, sin: {sin.shape}'
        query_states, key_states = apply_rotary_pos_emb(query_states, key_states, cos, sin)
...
class LLaVAOneVision1_5_TextModel(Qwen2VLPreTrainedModel):
    ...
    def forward(
        ...
        # assert 1==3, f'input_ids: {input_ids.shape if input_ids is not None else None}, inputs_embeds: {inputs_embeds.shape if inputs_embeds is not None else None}'
