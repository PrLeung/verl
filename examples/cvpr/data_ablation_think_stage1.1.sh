...
export WANDB_PROJECT=qwen2_5_vl_7b_data_ablation        # W&B 项目名称
...
DATASET_NAME="think_41k_ablation"
...
ray job submit --address="http://127.0.0.1:8265" \
    ...
    trainer.project_name=qwen2_5_vl_7b_data_ablation \
    trainer.experiment_name=think_41k_ablation_stage${STAGE} \
    ...
    trainer.resume_from_path=/data_1/ray/session_2025-11-13_22-27-26_602549_892259/runtime_resources/working_dir_files/_ray_pkg_0602390f6f797986/checkpoints/qwen2_5_vl_7b_data_ablation/think_41k_ablation_stage1_1/global_step_140 \
